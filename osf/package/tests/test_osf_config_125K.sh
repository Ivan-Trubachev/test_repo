...
test_case="OSF"
description="Test osf configuration BLE_125K"
...
KEY1="2B,7E,15,16,28,AE,D2,A6,AB,F7,15,88,09,CF,4F,CC"
# KEY2
...
KEY2="2C,7F,16,17,29,AF,D3,A7,AC,F8,16,89,0A,DF,5F,CC"
# Firmware version
#FWVER="301"
FWVER="305"
...
tc_7() {
  ...
  slip_output=$(timeout --preserve-status 2s slipcmd -H -b"$BAUDRATE" -sn -R'!SFPHY '"$PHY_BLE_125K" "$SERIALPORT")
